...
def main():
    ...
    parser.add_argument('--model_path', type=str, default=os.path.join(script_dir, 'offroad-autonomy-segmentation', 'outputs', 'segmentation_head.pth'),
                        help='Path to trained model weights')
    parser.add_argument('--data_dir', type=str, default=os.path.join(script_dir, 'offroad-autonomy-segmentation', 'dataset', 'Offroad_Segmentation_Training_Dataset', 'Offroad_Segmentation_Training_Dataset', 'val'),
    ...
    repo_dir = os.path.join(script_dir, 'offroad-autonomy-segmentation', 'dinov2')
